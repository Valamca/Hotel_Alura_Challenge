...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
		...
		lblNewLabel_2.setBounds(52, 10, 150, 150);
		...
		btnRegistro.setBounds(0, 222, 257, 56);
		btnRegistro.setBackground(new Color(51, 153, 204));
		...
		btnBusqueda.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				btnBusqueda.setBackground(new Color(130, 210, 160));				
			}
			@Override
			public void mouseExited(MouseEvent e) {
				btnBusqueda.setBackground(new Color(0, 102, 102));	
			}
			@Override
			public void mouseClicked(MouseEvent e) {
		...
		btnBusqueda.setBounds(0, 288, 257, 56);
		btnBusqueda.setBackground(new Color(51, 153, 204));
		...
		separator.setBounds(25, 185, 201, 2);
		panelMenu.add(separator);
		
		JLabel PrincipalImagen = new JLabel("");
		PrincipalImagen.setBounds(-199, -415, 1024, 1024);
		panelMenu.add(PrincipalImagen);
		header.setLayout(null);
		header.setBackground(Color.WHITE);
		PrincipalImagen.setIcon(new ImageIcon(Login.class.getResource("/images/Hotel3.jpg")));
	    ...
	    panelFecha.setBackground(new Color(0, 153, 204));
	    ...
	    labelDescripcion_1.setBackground(new Color(255, 255, 255));
	    labelDescripcion_1.setForeground(Color.BLACK);
