...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		...
		imagenFondo.setIcon(new ImageIcon(MenuPrincipal.class.getResource("/images/Hotel8.jpg")));
		panel.add(imagenFondo);
		
		JLabel logo = new JLabel("");
		logo.setBounds(679, 74, 150, 156);
		...
		JLabel lblCopyR = new JLabel("Desarrollado por Valam Cortes © 2023");
		...
		btnexit.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                int result = JOptionPane.showConfirmDialog(
                	new JFrame()," ¿Quieres salir de la aplicacíon?" ,"¡Aviso!" ,JOptionPane.YES_NO_OPTION);
                if(result == 0) {
                	JOptionPane.showMessageDialog(new JFrame(), "¡Gracias por visitarnos!");
                    System.exit(0);
                }
			}
			@Override
		...
		btnLogin.setBounds(723, 299, 83, 70);
		...
		lblTitulo.setBounds(722, 265, 83, 24);
